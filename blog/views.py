...
class ArticleDetailView(DetailView):
	...
	queryset = Article.objects.all() #limits the choices available for the detail view
...
class ArticleUpdateView(UpdateView):
	...
	def get_object(self):
		...
		return get_object_or_404(Article, id=id_) # this methid grabs the object or instance were trying tochange
